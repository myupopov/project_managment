...
export default function Projects({ projects, onProjectSelect }) {
  ...
  return (
    <div className=" p-8 pt-16 h-[calc(100vh)] w-1/4 bg-black rounded-tr-xl">
      ...
      <button onClick={() => handleProjectSelect(null)} className="px-4 py-2 text-base rounded-md bg-stone-700 text-stone-400 hover:bg-stone-600 hover:text-stone-100">+ Add projects</button>
